...
from check_mat import DataLoader
from tf_model import Model 


#takes in various arguments. Need overhaul.
def main():
...
def train(args):
    ...
    """
    Create Training Session Pipeline
    """
    with tf.Session() as sess:
        ...
        for e in range(args.num_epochs):
            ...
            for b in range(data_loader.num_batches): #for each batch
                start = time.time()
                x, y = data_loader.next_batch() #data loader provides next batch.
